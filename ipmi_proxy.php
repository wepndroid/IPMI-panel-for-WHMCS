...
function ipmiProxyBuildKvmRuntimeProgressHelpersJs(): string
{
    return ''
        ...
        . 'if((tFailed||txBlockLive)&&live&&sessR){try{_kvmDbg("ilo_strong_confirmation_rejected_transport_unhealthy",{tv:tv,live:1,sessR:1});}catch(_rtu){}return {ok:false,why:"transport_unhealthy_console_not_confirmed",transport_verdict:tv};}'
